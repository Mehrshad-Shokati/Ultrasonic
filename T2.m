...
Nsi = 200; % Original number of sampling points for 'si'
N_phi_max = 200; % Original number of angular samples
si_max = pi/3; % Maximum angle for the simulation
element_Number = 63; % Original number of elements in the annular array
...
for i = 1:Nsi
    ...
    for j = 1:N_phi_max
        ...
        if mod(counter, 1000) == 0 % Show progress every 1000 calculations
