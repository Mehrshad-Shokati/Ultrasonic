...
% The stimulation of each transducer element is adjusted to produce a "T" pattern.
...
vertical_indices = [29, 30, 31, 32, 33]; % Adjust these indices as needed

% Define the indices for the horizontal part of the "T"
horizontal_indices = [16, 30, 46]; % Adjust these indices as needed
